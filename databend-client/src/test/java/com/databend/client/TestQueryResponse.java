...
public class TestQueryResponse {
    private static final JsonCodec<QueryResponse> QUERY_RESULTS_CODEC = jsonCodec(QueryResponse.class);
    ...
    public void testBasic() {
        ...
        QueryResponse queryResults = QUERY_RESULTS_CODEC.fromJson(goldenValue);
    ...
    public void TestDateTime() {
        ...
        QueryResponse queryResults = QUERY_RESULTS_CODEC.fromJson(goldenString);
    ...
    public void TestArray() {
        ...
        QueryResponse queryResponse = QUERY_RESULTS_CODEC.fromJson(goldenString);
        Assert.assertEquals(queryResponse.getQueryId(), "eecb2440-0180-45cb-8b21-23f4a9975df3");
        Assert.assertEquals(queryResponse.getSchema().size(), 5);
        Assert.assertEquals(queryResponse.getSchema().get(0).getName(), "id");
        Assert.assertEquals(queryResponse.getSchema().get(0).getDataType().getType(), "Int8");
    }
    ...
    public void TestVariant() {
        ...
        Assert.assertEquals(queryResponse.getSchema().size(), 1);
        Assert.assertEquals(queryResponse.getSchema().get(0).getName(), "var");
        Assert.assertEquals(queryResponse.getSchema().get(0).getDataType().getType(), "Variant");
        Assert.assertEquals(queryResponse.getSchema().get(0).getDataType().isNullable(), true);
    }
