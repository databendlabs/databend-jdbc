...
import static com.databend.jdbc.internal.data.DatabendRawType.startsWithIgnoreCase;
...
public enum DatabendDataType {
    ...
    BITMAP(Types.OTHER, DatabendTypes.BITMAP, false, 0, false, "Bitmap"),
    TUPLE(Types.STRUCT, DatabendTypes.TUPLE, false, 0, false, "Tuple"),
